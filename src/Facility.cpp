...
//FacilityType
    ...
    //empty constructor
    FacilityType::FacilityType(): name(""), category(FacilityCategory::ECONOMY), price(0), lifeQuality_score(0), economy_score(0), environment_score(0) {};
...
//Facility
    //empty constructor
    Facility::Facility(): FacilityType(), settlementName(""), status(FacilityStatus:: UNDER_CONSTRUCTIONS),timeLeft(0) {};
